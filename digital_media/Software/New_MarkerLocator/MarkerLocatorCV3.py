...
class CameraDriver:
    ...
    def __init__(self, marker_orders=[6], default_kernel_size=14, scaling_parameter=2500, downscale_factor=1):
...
def main():
    ...
    cd = CameraDriver(list_of_markers_to_find, default_kernel_size=14, scaling_parameter=1000, downscale_factor=2)  # Best in robolab.
